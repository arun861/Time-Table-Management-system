...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/img1.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/img2.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Prof. Y Vrushabhendrappa</h3>
                    <hr/>
                    <h4 align="center">Director<br/>Bapuji Institue of Engineering & Technology</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr H.B Arvinda</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> Bapuji Institute Of Engineering and Technology</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/hod.jpeg" class="img-rounded"/>
                    <h3 align="center">Dr Nirmala C.R</h3>
                    <hr/>
                    <h4 align="center">HOD<br/>Department Of Computer Science and Engineering</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Bapuji Institute of Engineering and Technology<br>
	P.O.Box No. 325, Shamanur Road<br>
	Davangere, Karnataka, 577004

                </h4>
                <h4><strong>Call:</strong> 08192-222245 </h4>
                <h4><strong>Email: </strong>principal@biet.edu</h4>
            </div>
